...
<html >
<head>
  <title>Login Form|Acqualina</title>
	...
	<div class="w3layouts-top-strip">
			<div class="top-srip-agileinfo">
				<div class="w3ls-social-icons text-left">
					...
					<div style="color:blue;">Welcome to Acqualina</div>
				</div>
        ...
        <div id="signup">   
          ...
          <div class="field-wrap">
            <label>
             ...
             <input type="password" name="txtp1"required autocomplete="off"/>
          </div>
		<div class="field-wrap">
			<label>
              confirm Password<span class="req">*</span>
            </label>
            <input type="password" name="txtp2" required autocomplete="off"/>
          </div>
			<div class="field-wrap">
            <label>
              mobile number<span class="req">*</span>
            </label>
            <input type="number" name="mnumber" required autocomplete="off"/>
          </div>
		  ...
		  <div class="field-wrap">
            ...
            <input type="text" name="txtcity" required autocomplete="off"/>
          </div>
