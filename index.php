  ...
  <div class="w3layouts-top-strip">
			<div class="top-srip-agileinfo">
				...
				<!--	<a class="facebook" href="#"><i class="fa fa-facebook"></i></a>
					...
					<div style="color:blue;">We welcomes you to our home......</div>
				</div>
				<div class="agileits-contact-info text-right">
					<ul>
						<li><i class="fa fa-volume-control-phone" aria-hidden="true"></i> +91 8095939757</li>
	...
	<div id="demo-1" data-zs-src='["image/b1.jpg", "image/b2.jpg", "image/b3.jpg","image/b4.jpg"]' data-zs-overlay="dots">
		...
		<!--//header-w3l-->
			<!--/banner-info-->
			   <div class="baner-info">   
			      <h3>Wel<span>Come </span>To   <span>Acqualina </span></h3>
				  <h4>Book Your Dream Rooms </h4>
 	...
 	<div class="special featured">
		  <div class="container">
				   <div class="ab-w3l-spa">
				        <h3 class="tittle">Welcome to Our Home!</h3>
					...
					<div class="price-block agile">
						...
						<div class="price-gd-bottom">
							...
							<div class="price-selet pric-sclr4">
                                                            <a href="booking.php" class="scroll" >Book Now</a>
							</div>
						</div>
					</div>
				</div>
