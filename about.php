  ...
  <div class="w3layouts-top-strip">
			<div class="top-srip-agileinfo">
				<div class="w3ls-social-icons text-left">
					...
					<div style="color:blue;">Welcome to Acqualina<span style ="color:red"> "</span>the world of joy<span style ="color:red">"</span></div>
				</div>
